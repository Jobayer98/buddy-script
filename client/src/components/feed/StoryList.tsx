    ...
    <div className="relative mb-4">
      ...
      <div className="hidden md:block relative">
        ...
        <div className="grid grid-cols-4 gap-3">
          {/* Create Story Card */}
          <div className="relative h-35 rounded-md overflow-hidden cursor-pointer">
            <Image
            ...
            <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center pb-4 gap-2">
              <button className="w-7.5 h-7.5 bg-primary rounded-full flex items-center justify-center border-2 border-white shadow">
          ...
          {demoStories.slice(1, 4).map((story, idx) => (
            <div
              key={story.id}
              className="relative h-35 rounded-md overflow-hidden cursor-pointer group"
            >
              <Image
              ...
              <div className="absolute top-3 right-3">
                <div className="w-7.5 h-7.5 rounded-full border-2 border-white overflow-hidden shadow">
                  <Image
        ...
        <ScrollArea className="w-full whitespace-nowrap">
          <div className="flex gap-3 px-1">
            ...
            {demoStories.slice(1).map((story, idx) => (
              ...
              >
                <div
                  className={`relative h-15 w-15 rounded-full overflow-hidden border-2 ${
                    idx % 2 === 0 ? "border-primary" : "border-[#c2c6ca]"
                  }`}
                >
                  <Image
                    src={story.image}
